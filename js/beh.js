...
function resize(){
    ...
    document.querySelector('#hello').style.minHeight = window.innerHeight+"px"
    ...
    document.querySelector('#games').style.minHeight = window.innerHeight+"px"
    ...
    document.querySelector('#articles-banner').style.minHeight = window.innerHeight+"px"
